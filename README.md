...
if a == 1:
            ...
            def jugar_ahorcado():
                ...
                while intentos_restantes > 0:
                    ...
                    if acierto:
                        ...
                        tiempo_transcurrido = time.time() - tiempo_inicial
                        tiempo_restante = tiempo_total - tiempo_transcurrido
                        print("¡Correct!. You have left", int (tiempo_restante), "segundos.")
                        ...
                        print("Incorrect. you have left ", intentos_restantes, "Attempts and", int (tiempo_restante), "seconds.")
            ...
            def jugar_ahorcado():
                ...
                while intentos_restantes > 0:
                    ...
                    if acierto:
                        ...
                        tiempo_transcurrido = time.time() - tiempo_inicial
                        tiempo_restante = tiempo_total - tiempo_transcurrido
                        print("¡Correct!. You have left", int (tiempo_restante), "seconds.")
                ...
                while intentos_restantes > 0:
                    ...
                    for i in range(len(palabra)):
                        if palabra[i].lower() == letra.lower():
                            ...
                            nueva_palabra_oculta += palabra_oculta
                            [i]
                    ...
                    if acierto:
                        ...
                        tiempo_transcurrido = time.time() - tiempo_inicial
                        tiempo_restante = tiempo_total - tiempo_transcurrido
                        print("Corretto!. Te ne sei andato", int(tiempo_restante), "secondi.")
                        ...
                        tiempo_transcurrido = time.time() - tiempo_inicial
                        tiempo_restante = tiempo_total - tiempo_transcurrido
                        print("Errato. Te ne sei andato", intentos_restantes, "tentativi e", int(tiempo_restante), "secondi.")
            ...
            def jugar_ahorcado():
                ...
                while intentos_restantes > 0:
                    ...
                    if acierto:
                        ...
                        print("Falsch. Du bist gegangen",intentos_restantes,"versuche und", int (tiempo_restante), "sekunden.")
            ...
            def jugar_ahorcado():
                ...
                while intentos_restantes > 0:
                    ...
                    if acierto:
                        ...
                        print("Incorrect. Ils te donnent", intentos_restantes, "tentatives et", int (tiempo_restante), "secondes.")
    ...
    if Multiplayer == 2:
        ...
        if b == 1:
            ...
            def adivinar_letra():
                return input("tippelj egy betűt: ")
            ...
            def jugar_ahorcado():
                ...
                while intentos_restantes > 0:
                    ...
                    if acierto:
                        ...
                        tiempo_transcurrido = time.time() - tiempo_inicial
                        tiempo_restante = tiempo_total - tiempo_transcurrido
                        print("helyes! Elmentél", int (tiempo_restante), "másodpercek.")
                        ...
                        print("Helytelen. Elmentél", intentos_restantes, "kísérletek és", int(tiempo_restante),"másodpercek.")
